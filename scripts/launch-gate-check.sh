...
pat={
  ...
  'gigabrain_provenance_warn': re.compile(r'gigabrain: loaded without install/load-path provenance', re.I),
...
# extra hard-check for gigabrain crashes in gateway.err.log
crash_count=0
crash_sample=None
...
if crash_sample:
  ln,msg=crash_sample
  print(f'gigabrain_errlog_error_lines\tline={ln}\t{msg}')

# Pragmatic launch gate logic
blockers = (
